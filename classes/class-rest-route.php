...
class BSCR_TTM_REST_ROUTE
{
	...
	{
		add_action('rest_api_init', [$this, 'bscr_ttm_rest_routes']);
	}

	public function bscr_ttm_rest_routes()
	{
		register_rest_route('bscr/v1', '/settings', [
			'methods' => 'GET',
			'callback' => [$this, 'bscr_ttm_get_settings'],
			'permission_callback' => [$this, 'bscr_get_settings_permission']
		]);
		register_rest_route('bscr/v1', '/settings', [
			'methods' => 'POST',
			'callback' => [$this, 'bscr_save_settings'],
			'permission_callback' => [$this, 'bscr_save_settings_permission']
		]);
	}
